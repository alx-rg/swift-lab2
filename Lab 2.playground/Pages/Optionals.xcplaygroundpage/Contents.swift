...
//let stringLength = alwaysAString.count
//print(stringLength)
...
//optionalString = "bob"
//var petName = optionalString ?? "Fido"
...
if let username = username {
    print("Wow it's been such a long time since we've seen you \(username)")
} else {
    print("What's your name friend?")
}

let anonyUser = username ?? "Anonymous"
print(anonyUser)
